...
static int allocate_data(void)
{
    ...
    cudaMallocManaged(&u ,size * sizeof(float));
    cudaMallocManaged(&v ,size * sizeof(float));
    cudaMallocManaged(&u_prev ,size * sizeof(float));
    cudaMallocManaged(&v_prev ,size * sizeof(float));
